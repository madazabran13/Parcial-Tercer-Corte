...
public class VentanaPregrado extends JDialog {
    ...
    private String titulos[]={"No Documento", "Nombre", "Apellido", "Programa Pregrado",
                              "Semestre","Corte 1", "Corte 2", "Corte 3"};
    
    private GestionEstudiantes gestor;
    
    public VentanaPregrado(JFrame frame, boolean bln) {
        super(frame, bln);
        this.setTitle("ESTUDIANTES DE PREGRADO");
